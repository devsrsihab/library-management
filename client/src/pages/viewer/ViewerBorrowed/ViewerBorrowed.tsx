...
import ConfirmModal from "./ViewerConfirmModal";
import { TBorrowProps } from "../../../types/borrowed.type";

const ViewerBorrowed: React.FC<TBorrowProps> = ({ borrowed }) => {
  const [openReturn, setOpenReturn] = useState(false);

  return (
    <>
      <div key={borrowed._id}>
        <ConfirmModal id={borrowed._id} openReturn={openReturn} setOpenReturn={setOpenReturn} />
