...
const Reviews = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center overflow-hidden">
      <div className="w-full max-w-6xl relative">
        <div className="absolute inset-0 bg-gradient-to-br from-[#125662] via-[#1a7d8c] to-[#2194a7] opacity-10 blur-3xl"></div>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center mb-6 sm:mb-8 md:mb-12 text-[#125662] relative z-10">
          Reader Experiences
        </h2>
